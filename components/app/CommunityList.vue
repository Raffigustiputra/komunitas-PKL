<template>
    ...
    <div class="flex justify-between items-center">
        <h1 class="text-2xl font-bold text-center my-6 text-black dark:text-white" v-if="!hideTextList">
            List Komunitas
        </h1>
        <div class="justify-center flex items-center gap-1" v-if="!hideSearchAndOptions">
    ...
    <div class="flex flex-col bg-white rounded-3xl px-5 py-3 hover:shadow-md hover:cursor-pointer shadow-sm dark:text-black"
        v-for="(komunitas, index) in filteredKomunitas" :key="komunitas.id" 
